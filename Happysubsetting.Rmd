...
respiration<-read.csv(file="SRSF25_35FullLipidsposmode.csv",header=TRUE)
respiration$Temperature <- as.factor(respiration$Temperature)
respiration$Time<-as.numeric(respiration$Time)

#str(respiration)

names(respiration)[1:5]
```
